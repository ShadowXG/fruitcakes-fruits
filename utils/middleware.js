...
//// Middleware function         ////
/////////////////////////////////////
// Now, instead of processing our midlleware in server.js, 
// we're going to build a function that will take the entire app as an argument,
// and run request through all of our middleware
const middleware = (app) => {
    // middleware runs before all the routes.
    // every request is processed through our middleware before mongoose can do anything with it
    // method-overried is middleware that allows us to utilize forms to their full potential
    ...
    // using express.static('public') allows us to serve a single CSS stylesheet across our app where we want to.
    app.use(express.static('public')) // this serves static files from the 'public' folder
    app.use(express.json()) // parses incoming request payloads with JSON
    // here, we set up and utilize a session function, and we pass that function a config argument, to configure our session in the way we want.
    // This argument will tell express-session how to create and store our session.
    ...
    // this secret is kinda like authorization, tha allows our app to create with connectMongo
